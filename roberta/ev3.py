...
class Hal(object):
    ...
    def resetMotorTacho(self, actorPort):
        self.BP.offset_motor_encoder(self.portMapping[actorPort], self.BP.get_motor_encoder(self.portMapping[actorPort]))

    def getMotorTachoValue(self, actorPort, mode):
        return self.BP.get_motor_encoder(self.portMapping[actorPort])
